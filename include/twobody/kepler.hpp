...
namespace TwoBody
{
    ...
    struct KeplerianElements
    {
         ...
         */
        constexpr OrbitClassification Classification() const noexcept
        {
            if (IsValid() == false)
            {
     ...
     */
    constexpr double Period(const KeplerianElements& Elements) noexcept
    {
        if ((Elements.IsValid() == true) && (Elements.IsClosed() == true)) 
        {
     ...
     */
    constexpr double Radius(const KeplerianElements& Elements) noexcept
    {
    ...
    {
        const auto Classification = Elements.Classification();
        ...
        const auto Rot = 
            ...
            Quaternion::FromVectorAngle(Vector3::UNIT_X(), -D2R(Elements.Inclination)) *
